...
def main():
    ...
    ap.add_argument("--out", default="results/eval_failures.csv")
    ap.add_argument("--max_text", type=int, default=220)
    args = ap.parse_args()
    ...
    failures = [r for r in rows if float(r.get("precision1", 0.0)) <= 0.0]
